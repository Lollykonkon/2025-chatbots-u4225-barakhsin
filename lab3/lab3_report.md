...
#### Пользователь 1
![Скриншот 1: Привязка гугл аккаунта и постановка задачи](Robert-1.jpg)
*Рисунок 1: Привязка гугл аккаунта и постановка задачи*

![Скриншот 1: Календарь](Robert-2.png)
*Рисунок 2: Задача в гугл календаре* \
**Отзыв: "Нифига, оно работает!"**

#### Пользователь 2
![Скриншот 1: Привязка гугл аккаунта и постановка задачи](Lev-1.png)
*Рисунок 1: Первоначальное взаимодействие с ботом*

![Скриншот 1: Календарь](Lev-2.png)
*Рисунок 2: Попытка взаимодействия с ботом после неудачного ввода* \
**Отзыв: "После добавления задачи отсутствует смена состояния пользователя для бота, не дает дальше взаимодействовать"**

#### Пользователь 3
![Скриншот 1: Привязка гугл аккаунта и постановка задачи](Ramiz-1.png)
*Рисунок 1: Привязка гугл аккаунта*

![Скриншот 1: Привязка гугл аккаунта и постановка задачи](Ramiz-2.png)
*Рисунок 2: Привязка гугл аккаунта 2*

![Скриншот 1: Привязка гугл аккаунта и постановка задачи](Ramiz-3.png)
*Рисунок 3: Постановка задачи*

![Скриншот 1: Календарь](Ramiz-4.png)
*Рисунок 4: Задача в гугл календаре* \
**Отзыв: "После добавления задачи отсутствует смена состояния пользователя для бота, не дает дальше взаимодействовать"**


### Видео работы бота
https://drive.google.com/file/d/1viHjvPbgNiivWCV_fV8NHI4KiDdMeE-v/view?usp=sharing
