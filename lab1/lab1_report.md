...
![Скриншот 1: Команда /start и справка по командам](start.png)
*Рисунок 1: Отображение справки по командам при запуске бота*
*Рисунок 1: Добавление задач и отображение списка с приоритетами*

![Скриншот 2: Команда /list и справка по командам](list.png)
*Рисунок 2: Установка приоритета "high" и дедлайна для задачи*
